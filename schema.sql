...
CREATE OR REPLACE FUNCTION "docs"."get_page_parents"("page_id" bigint) RETURNS TABLE("id" bigint, "parent_page_id" bigint, "path" "text", "meta" "jsonb")
    LANGUAGE "sql"
    AS $$
...
ALTER FUNCTION "docs"."get_page_parents"("page_id" bigint) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "docs"."match_page_sections"("embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "min_content_length" integer) RETURNS TABLE("id" bigint, "page_id" bigint, "slug" "text", "heading" "text", "content" "text", "similarity" double precision)
    LANGUAGE "plpgsql"
    AS $$
...
ALTER FUNCTION "docs"."match_page_sections"("embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "min_content_length" integer) OWNER TO "postgres";
...
ALTER TABLE "docs"."page" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "docs"."page_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "docs"."page_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "docs"."page_id_seq" OWNED BY "docs"."page"."id";
...
ALTER TABLE "docs"."page_section" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "docs"."page_section_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "docs"."page_section_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "docs"."page_section_id_seq" OWNED BY "docs"."page_section"."id";
...
CREATE TABLE IF NOT EXISTS "public"."file_workspaces" (
    ...
    "vs_file_id" "text",
    "meeting_date" "date",
    "meeting_year" smallint,
    "meeting_month" smallint,
    ...
    "language" "text",
    "file_ext" "text",
    "doc_profile_processed" boolean DEFAULT false NOT NULL,
    "doc_profile_processed_at" timestamp with time zone,
    "profile_summary" "text",
    "profile_keywords" "text"[],
    "profile_entities" "jsonb",
    "profile_generated_at" timestamp with time zone,
    "profile_version" integer DEFAULT 1,
    "profile_attempts" integer DEFAULT 0,
    "ingest_retries" smallint DEFAULT 0 NOT NULL,
    "ingest_failed" boolean DEFAULT false NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."prompt_evals" (
    ...
    "rubric" "text" DEFAULT 'legal_reasoning_v1'::"text",
    "topic" "text",
    "answer" "text",
    "citations" "jsonb",
    "score" numeric,
...
ALTER TABLE "public"."prompt_evals" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."workspace_vector_stores" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "workspace_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."workspace_vector_stores" OWNER TO "postgres";
...
ALTER TABLE ONLY "docs"."page" ALTER COLUMN "id" SET DEFAULT "nextval"('"docs"."page_id_seq"'::"regclass");



ALTER TABLE ONLY "docs"."page_section" ALTER COLUMN "id" SET DEFAULT "nextval"('"docs"."page_section_id_seq"'::"regclass");



ALTER TABLE ONLY "docs"."page"
...
ALTER TABLE ONLY "docs"."page_section"
...
ALTER TABLE ONLY "public"."prompt_evals"
    ADD CONSTRAINT "prompt_evals_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."workspace_vector_stores"
    ADD CONSTRAINT "workspace_vector_stores_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."workspace_vector_stores"
    ADD CONSTRAINT "workspace_vector_stores_workspace_id_key" UNIQUE ("workspace_id");
...
CREATE INDEX "file_workspaces_profile_entities_gin" ON "public"."file_workspaces" USING "gin" ("profile_entities");



CREATE INDEX "file_workspaces_profile_keywords_gin" ON "public"."file_workspaces" USING "gin" ("profile_keywords");
...
CREATE INDEX "file_workspaces_workspace_doc_type_idx" ON "public"."file_workspaces" USING "btree" ("workspace_id", "doc_type") WHERE (("deleted" = false) AND ("doc_type" IS NOT NULL));
...
CREATE INDEX "file_workspaces_workspace_meeting_date_idx" ON "public"."file_workspaces" USING "btree" ("workspace_id", "meeting_date") WHERE ("deleted" = false);



CREATE UNIQUE INDEX "file_workspaces_workspace_normalized_name_active_uq" ON "public"."file_workspaces" USING "btree" ("workspace_id", "normalized_name") WHERE (("deleted" = false) AND ("normalized_name" IS NOT NULL));



CREATE INDEX "file_workspaces_workspace_ordinance_idx" ON "public"."file_workspaces" USING "btree" ("workspace_id", "ordinance_number") WHERE (("deleted" = false) AND ("ordinance_number" IS NOT NULL));



CREATE INDEX "file_workspaces_workspace_year_month_idx" ON "public"."file_workspaces" USING "btree" ("workspace_id", "meeting_year", "meeting_month") WHERE ("deleted" = false);
...
CREATE INDEX "idx_files_ocr_needed_scanned" ON "public"."files" USING "btree" ("ocr_needed", "ocr_scanned");



CREATE INDEX "idx_fw_metadata_year_month" ON "public"."file_workspaces" USING "btree" ("workspace_id", "meeting_year", "meeting_month");



CREATE INDEX "idx_fw_pending_per_workspace" ON "public"."file_workspaces" USING "btree" ("workspace_id") WHERE (("ingested" = false) AND ("deleted" = false));



CREATE INDEX "idx_fw_workspace_ingested" ON "public"."file_workspaces" USING "btree" ("workspace_id", "ingested");
...
CREATE INDEX "idx_prompt_evals_message" ON "public"."prompt_evals" USING "btree" ("message_id");



CREATE INDEX "idx_prompt_evals_workspace_created" ON "public"."prompt_evals" USING "btree" ("workspace_id", "created_at" DESC);
...
CREATE OR REPLACE TRIGGER "set_updated_at" BEFORE UPDATE ON "public"."workspace_vector_stores" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
ALTER TABLE ONLY "docs"."page"
    ADD CONSTRAINT "page_parent_page_id_fkey" FOREIGN KEY ("parent_page_id") REFERENCES "docs"."page"("id");



ALTER TABLE ONLY "docs"."page_section"
    ADD CONSTRAINT "page_section_page_id_fkey" FOREIGN KEY ("page_id") REFERENCES "docs"."page"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."prompt_evals"
    ADD CONSTRAINT "prompt_evals_chat_id_fkey" FOREIGN KEY ("chat_id") REFERENCES "public"."chats"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prompt_evals"
    ADD CONSTRAINT "prompt_evals_message_id_fkey" FOREIGN KEY ("message_id") REFERENCES "public"."messages"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prompt_evals"
    ADD CONSTRAINT "prompt_evals_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."research_reports"
    ADD CONSTRAINT "research_reports_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."workspace_vector_stores"
    ADD CONSTRAINT "workspace_vector_stores_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "docs"."page" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "docs"."page_id_seq" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "docs"."page_section" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "docs"."page_section_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."prompt_evals" TO "anon";
GRANT ALL ON TABLE "public"."prompt_evals" TO "authenticated";
GRANT ALL ON TABLE "public"."prompt_evals" TO "service_role";
...
GRANT ALL ON TABLE "public"."workspace_vector_stores" TO "anon";
GRANT ALL ON TABLE "public"."workspace_vector_stores" TO "authenticated";
GRANT ALL ON TABLE "public"."workspace_vector_stores" TO "service_role";
