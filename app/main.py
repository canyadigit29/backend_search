...
from app.api import upload, chunk, embed, memory, project, task, background_tasks, compress, session_log, search
...
app.include_router(compress.router, prefix=settings.API_PREFIX)
