...
from app.api import (
    ...
    behavior, propose_behavior_change, trait  # ✅ Added trait
)
...
app.include_router(behavior.router, prefix=settings.API_PREFIX)
app.include_router(propose_behavior_change.router, prefix=settings.API_PREFIX)
app.include_router(trait.router, prefix=settings.API_PREFIX)  # ✅ Now registered
