...
from app.api import (
    ...
    behavior, propose_behavior_change  # ✅ Newly added
)
...
app.include_router(behavior.router, prefix=settings.API_PREFIX)               # ✅ Mounted behavior route
app.include_router(propose_behavior_change.router, prefix=settings.API_PREFIX)  # ✅ Mounted proposal route
