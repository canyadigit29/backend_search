...
from app.api.writing_ops import report_routes
...
app.include_router(report_routes.router, prefix=f"{settings.API_PREFIX}/writing", tags=["writing"])  # 📝 Writing/report route mounted
