...
def chunk_file(file_id: str, file_name: str, text: str, description: str = "", user_id: str = None, sharing: str = "private"):
    """
    ...
    try:
        ...
        for i, (chunk_text, meta) in enumerate(chunk_tuples):
            ...
            chunk = {
                ...
                "user_id": user_id,
                "tokens": num_tokens,
                "sharing": sharing,  # Add sharing status to each chunk
                **db_metadata,
            }
